...
var httpEndpoint = process.env.VUE_APP_GRAPHQL_HTTP || 'https://api.github.com/graphql'; // Files URL root

var filesRoot = process.env.VUE_APP_FILES_ROOT || httpEndpoint.substr(0, httpEndpoint.indexOf('/graphql'));
exports.filesRoot = filesRoot;
_vue["default"].prototype.$filesRoot = filesRoot; // Config
